...
public class GUI
{
    ...
    public GUI()
    {
        model = new DefaultTableModel(new String[]{"Proceso", "AT", "BT", "Prioridad", "WT", "TAT"}, 0);
        ...
        wtLabel = new JLabel("Tiempo promedio esperar:");
        wtLabel.setBounds(25, 425, 180, 25);
        tatLabel = new JLabel("Promedio de tiempo por turno:");
        ...
        computeBtn = new JButton("Calcular");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selected) {
                    ...
                    case "PSP":
                        ...
                        break;
                    case "RR":
                        String tq = JOptionPane.showInputDialog("Tiempo Quantum");
                        if (tq == null) {
                            return;
                        }
        ...
        frame = new JFrame("Simulador CPU procesos");

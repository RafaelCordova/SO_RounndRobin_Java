...
public class Proceso {
	 ...
	 * todos los valores seran pasados por parametros Este mŽtodo es œtil para
	 * la construcci—n de una cola de proceso en el que los datos provienen de
	...
	/**
	 * Ir a travŽs de los movimientos de la ejecuci—n de un ciclo de un
	...
	/**
	 * El inverso de ejecutando. Ir a travŽs de los movimientos de la espera
